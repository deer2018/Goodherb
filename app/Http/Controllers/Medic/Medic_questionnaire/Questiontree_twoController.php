...
class Questiontree_twoController extends Controller
{
    ...
    {
        $id = Auth::id();
        $_qt_3 = Questiontree_two::firstOrNew(array('user_id' => $id));
    ...
    public function store(Request $request)
    {
        ...
        $_qt_3 = Questiontree_two::firstOrNew(array('user_id' => $user_id));
        $_qt_3->fill($requestData)->save();

        return redirect('volunteer_question')->with('flash_message', 'Questiontree_two added!');
    }
