                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <?php echo csrf_field(); ?>
                                        ...
                                        <input id="email" type="email" class="form-control form-control-user" name="email" value="<?php echo e(old('email')); ?>" required autocomplete="email" autofocus placeholder="Email Address">
...
</html><?php /**PATH C:\xampp\htdocs\Goodherb\resources\views/auth/login2.blade.php ENDPATH**/ ?>