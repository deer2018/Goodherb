                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-1 font-weight-bold text-primary text-uppercase"><?php echo e($_qt_4->group); ?>
            ...
            <div class="card position-relative shadow h-100  border-bottom-success">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-2">
                        ...
                        <div> <?php echo $__env->make('medic.medic_volunteer.verify.quest1_medic', ['formMode' => 'quest1_medic.blade'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>
                    </div>
                                ...
                                <tbody>
                                    ...
                                    <?php $__currentLoopData = $medicines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td>
                                                <form method="POST" action="<?php echo e(url('/predicate1/' . $item->id)); ?>"
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                <div class="card position-relative shadow h-100 border-bottom-primary">
                    ...
                    <div class="card-body">
                        <form method="POST" id="advice_form" action="<?php echo e(url('/predicate1/' . $users->id)); ?>"
                            ...
                            <div class="form-group <?php echo e($errors->has('advice') ? 'has-error' : ''); ?>">
                                ...
                                <textarea class="form-control" name="advice" type="text" id="advice"
                                    ...
                                    value="<?php echo e(isset($diagnosis->advice) ? $diagnosis->advice : ''); ?>"><?php if (empty($advice['advice'])) {
                                            echo '';
                                        } else {
                                            echo $advice['advice'];
                                        } ?></textarea>
