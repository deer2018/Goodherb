...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h4 mb-0 text-gray-800">ข้อมูลของ<a class="m-1 font-weight-bold text-primary"> <?php echo e($users->username); ?></a> ครั้งที่ 2</h1>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card position-relative shadow h-100  border-bottom-dark">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                <?php echo $__env->make('questionnaireone.quest3', ['formMode' => 'quest2_check_medicine.blade'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                </div>
                            </div>
                        </div>
                    </div>
