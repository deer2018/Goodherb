...
Security
Insights
laravel-report-generator/src/views/general-pdf-template.blade.php
@Jimmy-JS
Jimmy-JS Using cursor() to get data faster
Latest commit 034977c on 15 Feb 2019
 History
 2 contributors
@Jimmy-JS@bgarrison25
265 lines (255 sloc)  8.21 KB
		...
		<div class="wrapper">
		    ...
		    <div class="content">
		    	<table width="100%" class="table">
					...
					?>
                    <?php $__currentLoopData = $query->when($limit, function($qry) use($limit) { $qry->take($limit); })->cursor(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $result): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						<?php
...
<?php /**PATH C:\xampp\htdocs\Goodherb\resources\views/medic/medic_index.blade.php ENDPATH**/ ?>