        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <!--แบบคัดเลือกอาสาสมัคร 10 ข้อคำถาม -->
                    ...
                    <form method="GET" action="{{ url('/medic_quest13') }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                    {{ csrf_field() }}
                        @include ('questionnaireone.quest3', ['formMode' => 'medic_quest3'])
