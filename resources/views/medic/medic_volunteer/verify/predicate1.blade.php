                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-1 font-weight-bold text-primary text-uppercase ">{{ $_qt_1->group }}</div>
                            </div>
                            <div class="col-auto">
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-1 font-weight-bold text-primary text-uppercase ">{{ $_qt_2->group }}</div>
                            </div>
                            <div class="col-auto">
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-1 font-weight-bold text-primary text-uppercase ">{{ $_qt_3->group }}</div>
                            </div>
                            <div class="col-auto">
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-1 font-weight-bold text-primary text-uppercase">{{ $_qt_4->group }}</div>
                            </div>
                            <div class="col-auto">
                                ...
                                <table class="table table-sm">
                                    ...
                                    @foreach($medicines as $item)
                                        <tr>
                                            ...
                                            <td>{{ $item->quantity }}</td>                                                                               
                                            <td>
                                                <form method="POST" action="{{ url('/predicate1/' . $item->id) }}" accept-charset="UTF-8" style="display:inline">
                                                    {{ method_field('DELETE') }}
                                                    {{ csrf_field() }}
