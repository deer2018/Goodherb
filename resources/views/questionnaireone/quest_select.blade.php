<table class="table table-bordered">
       ...
       <!--////////////////////////////// -->
         <tr>
            ...
            <td><div class="radio">
                <label><input name="ep4_1" type="radio" value="0" required> </label>
            </div> ไม่สามารถตักอาหารเข้าปากได้ ต้องมีคนป้อนให้</td>
         </tr>
         <tr>
            <td><div class="radio">
                <label><input name="ep4_1" type="radio" value="1" required> </label>
            </div> ตักอาหารเองได้แต่ต้องมีคนช่วย เช่น ช่วยใช้ช้อนตักเตรียมไว้ให้หรือตัดเป็นเล็กๆไว้ล่วงหน้า</td>
         </tr>
         <tr>
            <td><div class="radio">
                <label><input name="ep4_1" type="radio" value="2" required> </label>
         ...
         <tr>
            ...
            <td><div class="radio">
                <label><input name="ep4_2" type="radio" value="0" required> </label>
            </div> ต้องการความช่วยเหลือ</td>
         </tr>
         <tr>
            <td><div class="radio">
                <label><input name="ep4_2" type="radio" value="1" required> </label>
         ...
         <tr>
            ...
            <td><td><div class="radio">
                <label><input name="ep4_3" type="radio" value="0" required> </label>
            </div> ไม่สามารถนั่งได้ (นั่งแล้วจะล้มเสมอ) หรือต้องใช้คนสองคนช่วยกันยกขึ้น</td>
         </tr>
         <tr>
            <td><td><div class="radio">
                <label><input name="ep4_3" type="radio" value="1" required> </label>
   ...
   ทั่วไป 2 คนพยุงหรือดันขึ้นมาจึงจะนั่งอยู่ได้</td>
         ...
         <tr>
            <td><td><div class="radio">
                <label><input name="ep4_3" type="radio" value="2" required> </label>
            </div> ต้องการความช่วยเหลือบ้าง เช่นบอกให้ทำตาม หรือช่วยพยุงเล็กน้อย หรือต้องมีคนดูแลเพื่อความปลอดภัย</td>
         </tr>
         <tr>
            <td><td><div class="radio">
                <label><input name="ep4_3" type="radio" value="3" required> </label>
            </div> ทำได้เอง</td>
        ...
        <!--////////////////////////////// -->
         <tr>
            ...
            <td><td><div class="radio">
                <label><input name="ep4_4" type="radio" value="0" required> </label>
            </div> ช่วยตัวเองไม่ได้</td>
         </tr>
         <tr>
            <td><td><div class="radio">
                <label><input name="ep4_4" type="radio" value="1" required> </label>
            </div> ทำเองได้บ้าง (อย่างน้อยทำความสะอาดตัวเองได้หลังจากเสร็จธุระ) แต่ต้องการความช่วยเหลือในบางสิ่ง</td>
         </tr>
         <tr>
            <td><td><div class="radio">
                <label><input name="ep4_4" type="radio" value="2" required> </label>
   ...
   ถอดใส่เสื้อผ้าได้เรียบร้อย)</td>
         ...
         <tr>
            ...
            <td><td><div class="radio">
                <label><input name="ep4_5" type="radio" value="0" required> </label>
            </div> เคลื่อนที่ไปไหนไม่ได้</td>
         </tr>
         <tr>
            <td><td><div class="radio">
                <label><input name="ep4_5" type="radio" value="1" required> </label>
            </div> ต้องใช้รถเข็นช่วยตัวเองให้เคลื่อนที่ได้เอง (ไม่ต้องมีคนเข็นให้) และจะต้องเข้าออกมุมห้อง
   หรือประตูได้</td>
         </tr>
         <tr>
            <td><td><div class="radio">
                <label><input name="ep4_5" type="radio" value="2" required> </label>
            </div> เดินหรือเคลื่อนที่โดยมีคนช่วย เช่น พยุง หรือบอกให้ทำตาม หรือต้องให้ความสนใจดูแลเพื่อความปลอดภัย</td>
         </tr>
         <tr>
            <td><td><div class="radio">
                <label><input name="ep4_5" type="radio" value="3" required> </label>
         ...
         <tr>
            ...
            <td><td><div class="radio">
                <label><input name="ep4_6" type="radio" value="0" required> </label>
            </div> ต้องมีคนสวมใส่ให้ ช่วยตัวเองแทบไม่ได้หรือได้น้อย</td>
         </tr>
         <tr>
            <td><td><div class="radio">
                <label><input name="ep4_6" type="radio" value="1" required> </label>
            </div> ช่วยตัวเองได้ประมาณร้อยละ 50 ที่เหลือต้องมีคนช่วย</td>
         </tr>
         <tr>
            <td><td><div class="radio">
                <label><input name="ep4_6" type="radio" value="2" required> </label>
         ...
         <tr>
            ...
            <td><td><div class="radio">
                <label><input name="ep4_7" type="radio" value="0" required> </label>
            </div> ไม่สามารถทำได้</td>
         </tr>
         <tr>
            <td><td><div class="radio">
                <label><input name="ep4_7" type="radio" value="1" required> </label>
            </div> ต้องการคนช่วย</td>
         </tr>
         <tr>
            <td><td><div class="radio">
                <label><input name="ep4_7" type="radio" value="2" required> </label>
         ...
         <tr>
            ...
            <td><td><div class="radio">
                <label><input name="ep4_8" type="radio" value="0" required> </label>
            </div> ต้องมีคนช่วยหรือทำให้</td>
         </tr>
         <tr>
            <td><td><div class="radio">
                <label><input name="ep4_8" type="radio" value="1" required> </label>
            </div> อาบน้ำเองได้</td>
         ...
         <tr>
            ...
            <td><td><div class="radio">
                <label><input name="ep4_9" type="radio" value="0" required> </label>
            </div> กลั้นไม่ได้ หรือต้องการการสวนอุจจาระอยู่เสมอ</td>
         </tr>
         <tr>
            <td><td><div class="radio">
                <label><input name="ep4_9" type="radio" value="1" required> </label>
            </div> กลั้นไม่ได้บางครั้ง (เป็นน้อยกว่า 1 ครั้งต่อสัปดาห์)</td>
         </tr>
         <tr>
            <td><td><div class="radio">
                <label><input name="ep4_9" type="radio" value="2" required> </label>
        ...
        <!--////////////////////////////// -->
         <tr>
            ...
            <td><td><div class="radio">
                <label><input name="ep4_10" type="radio" value="0" required> </label>
            </div> กลั้นไม่ได้ หรือใส่สายสวนปัสสาวะแต่ไม่สามารถดูแลเองได้</td>
         </tr>
         <tr>
            <td><td><div class="radio">
                <label><input name="ep4_10" type="radio" value="1" required> </label>
            </div> กลั้นไม่ได้บางครั้ง (เป็นน้อยกว่าวันละ 1 ครั้ง)</td>
         </tr>
         <tr>
            <td><td><div class="radio">
                <label><input name="ep4_10" type="radio" value="2" required> </label>
            </div> กลั้นได้เป็นปกติ</td>
