...
<div class="container">
            ...
            <div class="col-md-10">
                ...
                <div id="13" class="tabcontent">
                    @include ('questionnaire.quest5', ['formMode' => 'volunteer_questionnaire_sub2_2'])
                </div>

                <td>
		        <div class="row">
	            <div class="col" style="text-align: left">
                <a href="{{ url('/volunteer_questionnaire_sub1_2') }}" class="btn btn-success btn-sm" title="Go_Back">
