...
<div class="container">
            ...
            <div class="col-md-10">
                ...
                <div id="13" class="tabcontent">
                    @include ('questionnairetwo.quest26', ['formMode' => 'volunteer_questionnaire_sub3_2'])
                </div>

                <td>
		        <div class="row">
	            <div class="col" style="text-align: left">
                <a href="{{ url('/Q2_2') }}" class="btn btn-success btn-sm" title="Go_Back">
                      <i class="fa fa-plus" aria-hidden="true"></i>ย้อนกลับ</a></div>
                <div class="col" style="text-align: right">
                <a href="{{ url('/Q2-4') }}" class="btn btn-success btn-sm" title="Go_Back">
